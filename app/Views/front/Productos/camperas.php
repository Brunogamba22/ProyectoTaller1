            ...
            <div class="row row-cols-1 row-cols-md-3 g-4">
                ...
                <div class="col">
                    <div class="card h-100">
                        <img src="assets/img/Camperas/Campera1.png" alt="Campera Rompevientos Hovy">
                        <div class="card-body">
                ...
                <div class="col">
                    <div class="card h-100">
                        <img src="assets/img/Camperas/Campera2.png" alt="Chaqueta Urban Ventura Negra">
                        <div class="card-body">
                ...
                <div class="col">
                    <div class="card h-100">
                        <img src="assets/img/Camperas/Campera3.png" alt="Campera Rompevientos Irupé Negra">
                        <div class="card-body">
                ...
                <div class="col">
                    <div class="card h-100">
                        <img src="assets/img/Camperas/Campera4.png" alt="Chaqueta Urban Oxnard Negra">
                        <div class="card-body">
